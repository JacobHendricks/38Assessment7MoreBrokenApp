...
const { authUser, requireLogin, requireAdmin, ensureCorrectUserOrAdmin } = require('../middleware/auth');
...
router.patch('/:username', authUser, requireLogin, ensureCorrectUserOrAdmin, async function(req, res, next) {
  try {
